...
function CptOverlayChart({ cpt, input, result, onChange }: ChartProps) {
  ...
  // norm-visualisatie zoals in externe referentie-berekeningen.
  ...
  return (
    <>
      ...
      {/* ─── 8D zone above paalpunt — light blue POLYGON ───
              ...
              Conform de externe referentie-visualisatiestijl voor qc;III. */}
      {zone8DVisible && (() => {
      ...
      {/* ─── qc curve ───
          Conform externe referentie-norm-visualisatie: de qc-polyline is
      ...
      {/* ─── In-chart gemiddelde qc-waarden per invloed-zone ───
          ...
          met halo voor leesbaarheid. Dit is hoe externe referentie-pakketten de
